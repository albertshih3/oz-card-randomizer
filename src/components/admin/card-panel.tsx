...
function getDisplayName(collectionId: string): string {
  return COLLECTION_DISPLAY_NAMES[collectionId] ?? collectionId;
}
...
export function CardPanel() {
  ...
  const filteredCards = useMemo(() => {
    ...
    return [...filtered].sort((a, b) => {
      ...
      switch (sortDescriptor.column) {
        ...
        case "collection":
          cmp = getDisplayName(a.collection).localeCompare(
            getDisplayName(b.collection),
          );
          break;
        case "active":
  ...
  }, [cards, filters.searchQuery, filters.statusFilter, sortDescriptor]);
