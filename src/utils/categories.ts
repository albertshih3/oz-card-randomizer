...
export const getDefaultCategories = (): Category[] => {
  return [
    ...
    {
      id: "californiatrail",
      name: "californiatrail",
      displayName: "California Trail",
      isWildcardEligible: false,
    },
    {
      id: "childrenszoo",
    ...
    {
      id: "newnaturefoundation",
      name: "newnaturefoundation",
      displayName: "New Nature Foundation",
      isWildcardEligible: false,
    },
    {
      id: "disney",
