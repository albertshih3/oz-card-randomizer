...
export default function CardManagement() {
  ...
  const toggleCardActive = async (card: any) => {
    const cardRef = doc(db, "your-collection", card.id);
  ...
  const handleCreateCard = async () => {
    try {
      const newCard = { name: newCardName, number: newCardNumber, active: newCardActive, category: newCardCategory };
      const docRef = await addDoc(collection(db, "your-collection"), newCard);
