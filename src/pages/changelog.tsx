    ...
    <DefaultLayout>
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-4">
          {(changelogData as unknown as ChangelogEntry[]).map(
                            ...
                            (section: ChangelogSection, idx: number) => (
                              <div key={idx} className="relative pl-4">
                                ...
                                <h3 className="text-base font-semibold flex items-center mb-3">
                                  <span
                                    className={`flex items-center justify-center w-6 h-6 rounded-md mr-3 ${getSectionColor(section.type)}`}
                                  >
                                ...
                                <ul className="space-y-3 pl-9">
                                  {section.items.map((item, itemIdx) => (
                                    <li
                                      key={itemIdx}
                                      className="text-muted-foreground text-sm leading-relaxed relative"
                                    >
